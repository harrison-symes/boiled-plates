  ...
  return knex('cats').del()
    .then(function () {
      ...
      return knex('cats').insert([
        ...
        { id: 4, name: 'prick', image: 'http://i9.photobucket.com/albums/a92/DanLeCrinque/beforemarriage.jpg', lifestory: 'A snitching backstabber', colour: 'should be orange, but has been burnt so blackish now', lives: 0.5 },
        { id: 5, name: 'brick', image: 'http://i9.photobucket.com/albums/a92/DanLeCrinque/beforemarriage.jpg', lifestory: 'Has a short but fat dick', colour: 'no hair, so pink', lives: 10000 },
        { id: 6, name: 'rajal', image: 'http://i9.photobucket.com/albums/a92/DanLeCrinque/beforemarriage.jpg', lifestory: 'I dominate ', colour: 'black', lives: 9000 }
      ])
    })
}
